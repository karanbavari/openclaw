...
## CLI and container benchmarks

CLI startup benchmarks and containerized onboarding smoke flows are not shipped in this CRM-focused fork anymore.
Keep testing focused on backend runtime, web UI, retained messaging channels, and business-domain flows.
