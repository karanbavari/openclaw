...
If you want the lowest-friction local setup in this fork, start with LM Studio or another OpenAI-compatible local endpoint and use `openclaw onboard --auth-choice custom-api-key`. This page is the opinionated guide for higher-end local stacks and custom OpenAI-compatible local servers.
