...
let commandSecretTargetsModulePromise:
  | Promise<typeof import("../internal-cli/command-secret-targets.js")>
  | undefined;
let commandSecretGatewayModulePromise:
  | Promise<typeof import("../internal-cli/command-secret-gateway.js")>
  | undefined;
...
function loadCommandSecretTargetsModule() {
  commandSecretTargetsModulePromise ??= import("../internal-cli/command-secret-targets.js");
  return commandSecretTargetsModulePromise;
}

function loadCommandSecretGatewayModule() {
  commandSecretGatewayModulePromise ??= import("../internal-cli/command-secret-gateway.js");
