...
export async function loadStatusScanModuleForTest(
  ...
  if (options.fastJson) {
    ...
    vi.doMock("../internal-cli/command-secret-targets.js", () => ({
    ...
    vi.doMock("../internal-cli/progress.js", () => ({
  ...
  vi.doMock("../internal-cli/command-secret-gateway.js", () => ({
  ...
  vi.doMock("../internal-cli/plugin-registry.js", () => createStatusPluginRegistryModuleMock(mocks));
