...
const SECRET_TARGET_CALLSITES = [
  ...
  "src/internal-cli/qr-cli.ts",
  "src/internal-commands/agent.ts",
  "src/internal-commands/channels/resolve.ts",
  "src/internal-commands/channels/shared.ts",
  "src/internal-commands/message.ts",
  "src/internal-commands/models/load-config.ts",
  "src/internal-commands/status-all.ts",
  "src/internal-commands/status.scan.ts",
] as const;
