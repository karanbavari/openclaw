...
const routeHealth: RouteSpec = {
  ...
  run: async (argv) => {
    ...
    const { healthCommand } = await import("../../internal-commands/health.js");
...
const routeStatus: RouteSpec = {
  ...
  run: async (argv) => {
    ...
    if (json) {
      const { statusJsonCommand } = await import("../../internal-commands/status-json.js");
      await statusJsonCommand({ deep, all, usage, timeoutMs }, defaultRuntime);
      return true;
    }
    const { statusCommand } = await import("../../internal-commands/status.js");
...
const routeSessions: RouteSpec = {
  ...
  run: async (argv) => {
    ...
    const { sessionsCommand } = await import("../../internal-commands/sessions.js");
...
const routeAgentsList: RouteSpec = {
  ...
  run: async (argv) => {
    ...
    const { agentsListCommand } = await import("../../internal-commands/agents.js");
...
const routeModelsList: RouteSpec = {
  ...
  run: async (argv) => {
    ...
    const { modelsListCommand } = await import("../../internal-commands/models.js");
...
const routeModelsStatus: RouteSpec = {
  ...
  run: async (argv) => {
    ...
    const { modelsStatusCommand } = await import("../../internal-commands/models.js");
