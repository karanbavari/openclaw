...
vi.mock("../../internal-commands/sessions.js", () => ({
  sessionsCommand: mocks.sessionsCommand,
}));

vi.mock("../../internal-commands/sessions-cleanup.js", () => ({
  sessionsCleanupCommand: mocks.sessionsCleanupCommand,
}));

vi.mock("../../internal-commands/tasks.js", () => ({
...
vi.mock("../../internal-commands/flows.js", () => ({
