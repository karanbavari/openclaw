...
vi.mock("../../internal-commands/auth-choice-options.static.js", () => ({
  formatStaticAuthChoiceChoicesForCli: () => "token|oauth",
}));

vi.mock("../../internal-commands/auth-choice-options.js", () => ({
  formatAuthChoiceChoicesForCli: () => "token|oauth|openai-api-key",
}));

vi.mock("../../internal-commands/onboard-core-auth-flags.js", () => ({
