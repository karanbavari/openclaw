...
vi.mock("../internal-commands/message.js", () => ({ messageCommand: programMocks.messageCommand }));
vi.mock("../internal-commands/status.js", () => ({ statusCommand: programMocks.statusCommand }));
vi.mock("../internal-commands/configure.js", () => ({
...
vi.mock("../internal-commands/setup.js", () => ({ setupCommand: programMocks.setupCommand }));
vi.mock("../internal-commands/onboard.js", () => ({
...
vi.mock("../internal-commands/doctor-config-flow.js", () => ({
