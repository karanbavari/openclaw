...
export function registerChannelsCli(program: Command) {
  ...
  channels
    ...
    .action(async (opts) => {
      await runChannelsCommand(async () => {
        const { channelsListCommand } = await import("../internal-commands/channels.js");
  ...
  channels
    ...
    .action(async (opts) => {
      await runChannelsCommand(async () => {
        const { channelsStatusCommand } = await import("../internal-commands/channels.js");
  ...
  channels
    ...
    .action(async (opts) => {
      await runChannelsCommand(async () => {
        const { channelsCapabilitiesCommand } = await import("../internal-commands/channels.js");
  ...
  channels
    ...
    .action(async (entries, opts) => {
      await runChannelsCommand(async () => {
        const { channelsResolveCommand } = await import("../internal-commands/channels.js");
  ...
  channels
    ...
    .action(async (opts) => {
      await runChannelsCommand(async () => {
        const { channelsLogsCommand } = await import("../internal-commands/channels.js");
  ...
  channels
    ...
    .action(async (opts, command) => {
      await runChannelsCommand(async () => {
        const { channelsAddCommand } = await import("../internal-commands/channels.js");
  ...
  channels
    ...
    .action(async (opts, command) => {
      await runChannelsCommand(async () => {
        const { channelsRemoveCommand } = await import("../internal-commands/channels.js");
